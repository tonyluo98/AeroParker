...
<title>Avalon City Registration</title>
</head>
	...
	<div class="row justify-content-center">
		<table>
			...
			<tr>
				...
				<td><input type="text" name="address1" maxlength="255" required></td>
			</tr>
			<tr>
			...
			<tr>
				<td>Postcode</td>
				<td><input type="text" name="postcode" maxlength="10" required></td>
			</tr>
			<tr>
